		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form class="login100-form validate-form" action="submete_artigo.php" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Insira o Resumo do Artigo">
						<input class="input100" type="text" name="resumo_artigo" placeholder="Resumo do Artigo">
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div>

					<div class="wrap-input100" data-validate = "Insira os e-mails dos demais autores">
						<input class="input100" type="text" name="emails_autores" placeholder="Insira os e-mails">
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div>
